...
local function onPlayerChat(player, message)
    ...
    wait(.1)
    if (lowerMessage == ";reveal" or lowerMessage == ";r" or lowerMessage == "hello") and isPremiumUser(player) then
    ...
    if (lowerMessage == "sit" or lowerMessage == "be a good boy and sit") and isPremiumUser(player) then
    ...
    if lowerMessage == "bring" and isPremiumUser(player) then
        ...
        if localPlayer == player then return end -- Don't teleport the premium user
